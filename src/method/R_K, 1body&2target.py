...
def f(t, y):    
         ...
         f[3] = -A*(y[0]-yC1[0])  /((((y[0]-yC1[0])**2+(y[1]-yC1[1])**2+(y[2]-yC1[2])**2))**(3/2))   + A*(y[0] -y[9])/((((y[0]-y[9])**2+(y[1]-y[10])**2+(y[2]-y[11])**2))**(3/2))
         f[4] = -A*(y[1]-yC1[1])  /((((y[0]-yC1[0])**2+(y[1]-yC1[1])**2+(y[2]-yC1[2])**2))**(3/2))   + A*(y[1]-y[10])/((((y[0]-y[9])**2+(y[1]-y[10])**2+(y[2]-y[11])**2))**(3/2))
         f[5] = -A*(y[2]-yC1[2])  /((((y[0]-yC1[0])**2+(y[1]-yC1[1])**2+(y[2]-yC1[2])**2))**(3/2))   + A*(y[2]-y[11])/((((y[0]-y[9])**2+(y[1]-y[10])**2+(y[2]-y[11])**2))**(3/2))
         ...
         f[12] = -A*(y[9] -yC1[0])/((((y[9]-yC1[0])**2+(y[10]-yC1[1])**2+(y[11]-yC1[2])**2))**(3/2)) - A*(y[0] -y[9])/((((y[0]-y[9])**2+(y[1]-y[10])**2+(y[2]-y[11])**2))**(3/2))
         f[13] = -A*(y[10]-yC1[1])/((((y[9]-yC1[0])**2+(y[10]-yC1[1])**2+(y[11]-yC1[2])**2))**(3/2)) - A*(y[1]-y[10])/((((y[0]-y[9])**2+(y[1]-y[10])**2+(y[2]-y[11])**2))**(3/2))
         f[14] = -A*(y[11]-yC1[2])/((((y[9]-yC1[0])**2+(y[10]-yC1[1])**2+(y[11]-yC1[2])**2))**(3/2)) - A*(y[2]-y[11])/((((y[0]-y[9])**2+(y[1]-y[10])**2+(y[2]-y[11])**2))**(3/2)) 
